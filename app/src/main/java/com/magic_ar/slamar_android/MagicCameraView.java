...
/**
 *
 * Created by cgnerds on 2017/7/26.
 *
 ...
 */
public class MagicCameraView extends CameraBridgeViewBase implements PreviewCallback {
    ...
    public MagicCameraView(Context context, int cameraId) {
    ...
    protected boolean connectCamera(int width, int height) {
        ...
        mStopThread = false;
        mThread = new Thread(new MagicCameraView.CameraWorker());
        mThread.start();
