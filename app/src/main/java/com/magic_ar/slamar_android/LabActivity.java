...
/**
 * Created by 38325 on 2017/7/10.
 */

public class LabActivity extends AppCompatActivity {
    public static final String PHOTO_FILE_EXTENTION = ".png";
    public static final String PHOTO_MIME_TYPE = "image/png";
    public static final String EXTRA_PHOTO_URI = "com.magic_ar.slamar_android.LabActivity.extra.PHOTO_URI";
    public static final String EXTRA_PHOTO_DATA_PATH = "com.magic_ar.slamar_android.LabActivity.extra.PHOTO_DATA_PATH";
